...
class KnowledgeSearch(BaseModel):
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["knowledgeBaseId", "name", "description", "failFast", "type"]
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['knowledge_search']):
            raise ValueError("must be one of enum values ('knowledge_search')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KnowledgeSearch from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KnowledgeSearch from a dict"""
        if obj is None:
            return None
