...
class TranscriptText(BaseModel):
    ...
    """ # noqa: E501
    content: StrictStr = Field(description="The assistant text.")
    citations: List[Citation] = Field(description="Sources cited in this block, deduplicated by URL. Empty unless the model cited any.")
    type: StrictStr
    __properties: ClassVar[List[str]] = ["content", "citations", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TranscriptText from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TranscriptText from a dict"""
        if obj is None:
            return None
