...
class ContentMessageResponse(BaseModel):
    ...
    """ # noqa: E501
    role: Role = Field(description="Message direction / role.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContentMessageResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContentMessageResponse from a dict"""
        if obj is None:
            return None
