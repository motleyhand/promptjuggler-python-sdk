...
class WorkflowCall(BaseModel):
    ...
    """ # noqa: E501
    version_ref: VersionRef = Field(description="Referencing the workflow revision either by id or version number or tag.", alias="versionRef")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkflowCall from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkflowCall from a dict"""
        if obj is None:
            return None
