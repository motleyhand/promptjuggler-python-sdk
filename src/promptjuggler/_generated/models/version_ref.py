...
class VersionRef(BaseModel):
    ...
    """ # noqa: E501
    parent_id: UUID = Field(description="Definition – prompt or workflow – ID.", alias="parentId")
    id_or_tag: VersionRefIdOrTag = Field(alias="idOrTag")
    __properties: ClassVar[List[str]] = ["parentId", "idOrTag"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VersionRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VersionRef from a dict"""
        if obj is None:
            return None
